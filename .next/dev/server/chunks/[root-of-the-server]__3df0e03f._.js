...
async function POST(request) {
    try {
        ...
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].category.findUnique({
            where: {
                id: categoryId
            },
            include: {
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].item.create({
            data: {
                name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3df0e03f._.js.map